...
const DashboardApp: React.FC = () => {
    ...
    <View style={styles.container}>
      <View style={styles.headerContainer}>
        ...
        <View style={styles.buttonsContainer}>
          <TouchableOpacity onPress={() => setActiveSection('Profile')} style={styles.button}>
            <Icon name="person" size={30} color="white" />
            <Text style={styles.buttonText}>
              Profile
            </Text>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => setActiveSection('Settings')} style={styles.button}>
  ...
  const ProfileSection: React.FC = () => (
    <View style={styles.container}>
      ...
      <View style={styles.contentContainer}>
        ...
        <Text style={styles.contentText}>
          Email: sairam.chundru1432@gmail.com
        </Text>
      </View>
    </View>
  );
  ...
  const PressableFeatureBox: React.FC<{ name: string, icon: string, onPress: () => void }> = ({ name, icon, onPress }) => (
  ...
  const CalendarSection: React.FC = () => (
    <View style={styles.container}>
      ...
      <View style={styles.contentContainer}>
        ...
        <EventItem date="Mon, Jan 10" time="3:00 PM - 5:00 PM" title="Meeting with Team" location="Office Conference Room" />
        <EventItem date="Thu, Jan 13" time="10:00 AM - 12:00 PM" title="Client Presentation" location="Online" />
        <EventItem date="Sat, Jan 15" time="6:00 PM - 8:00 PM" title="Dinner with Friends" location="Local Restaurant" />
      </View>
    </View>
  );
  ...
  const EventItem: React.FC<{ date: string, time: string, title: string, location: string }> = ({ date, time, title, location }) => (
